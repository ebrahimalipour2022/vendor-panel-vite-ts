...
} from '@/layouts/materialize-layout/@menu/menuTypes';

// Component Imports
import {
  MenuItem as HorizontalMenuItem,
  SubMenu as HorizontalSubMenu,
} from '@/layouts/materialize-layout/@menu/horizontal-menu';
import {
...
export const GenerateVerticalMenu = ({ menuData }: { menuData: VerticalMenuDataType[] }) => {
  ...
  const renderMenuItems = (data: VerticalMenuDataType[]) => {
    ...
    return data.map((item: VerticalMenuDataType, index) => {
      ...
      // Localize the href
      //const href = menuItem.href?.startsWith('http') ? menuItem.href : menuItem.href && menuItem.href
