...
// Type Imports
import type { PrimaryColorConfig } from '@/layouts/materialize-layout/configs/primaryColorConfig';
import primaryColorConfig from '@/layouts/materialize-layout/configs/primaryColorConfig';
...
const DebouncedColorPicker = (props: DebouncedColorPickerProps) => {
  ...
  return (
    <>
      <HexColorPicker
        color={
          !isColorFromPrimaryConfig ? settings.primaryColor ?? primaryColorConfig[0].main : '#eee'
        }
...
const Customizer = ({
  ...
  const isColorFromPrimaryConfig = primaryColorConfig.find(
    (item: { main: string | undefined }) => item.main === settings.primaryColor
  );
    ...
    >
      <div
        className={classnames(
          'customizer-toggler flex items-center justify-center cursor-pointer',
          styles.toggler
        )}
      ...
      <div
        className={classnames('customizer-header flex items-center justify-between', styles.header)}
      >
          ...
          <div className="theming-section flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-between">
                {primaryColorConfig.map((item: any) => (
                  <div
                    key={item.main}
          ...
          <div className="layout-section flex flex-col gap-6">
            ...
            {!disableDirection && (
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-4">
                  {/*<Link to={getLocalePath(pathName, 'en')}>*/}
                  {/*  <div className="flex flex-col items-start gap-0.5">*/}
                  {/*    <div*/}
                  {/*      className={classnames(styles.itemWrapper, {*/}
                  ...
                  {/*  </div>*/}
                  {/*</Link>*/}
                  {/*<Link to={getLocalePath(pathName, 'fa')}>*/}
                  {/*  <div className="flex flex-col items-start gap-0.5">*/}
                  {/*    <div*/}
                  {/*      className={classnames(styles.itemWrapper, {*/}
